...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F2}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F3}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F4}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F5}
	\caption{Attacks aimed to create a fork with length 2}
	\label{fig:f1}
\end{figure}
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F6}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/6/F7}
