...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F2}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F3}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F4}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F5}
	\caption{Attacks aimed to create a fork with length 2}
	\label{fig:f1}
\end{figure}
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F6}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L6_F7}
