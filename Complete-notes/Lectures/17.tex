...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Fig/L17_F2}
...
Thus, in terms of guaranteeing safety and liveness under a wide variety of conditions, Hybrid Consensus actually does worse than the longest-chain protocol { it does not guarantee liveness under variable participation.
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.6\linewidth]{Fig/L17_F3}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\linewidth]{Fig/L17_F4}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.7\linewidth]{Fig/L17_F5}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.6\linewidth]{Fig/L17_F6}
